...
| `getItemString*`    | **function** (<br />`nodeType`\*: `string`<br />`data`\*: `any`<br />`itemType`\*: React.ReactNode<br />`itemString`\*: `string`<br />`keyPath`\*: (`string`, `number`)<br />\[]<br />) => `ReactChild` \| `ReactFragment` \| `ReactPortal` \| `boolean` \| `null` \| `undefined` | `JSONNestedNodeCircularPropsPassedThroughJSONTree` |
