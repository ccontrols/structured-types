...
| `keyPath*`          | (`string`, `number`)<br />\[]                                                                                                                                                                                                                                                                                                                            | `SharedCircularPropsPassedThroughJSONTree`         |
| `labelRenderer*`    | **function** (<br />`keyPath`\*: (`string`, `number`)<br />\[]<br />`nodeType`\*: `string`<br />`expanded`\*: `boolean`<br />`expandable`\*: `boolean`<br />) => `ReactChild` \| `ReactFragment` \| `ReactPortal` \| `boolean` \| `null` \| `undefined`                                                                                                  | `SharedCircularPropsPassedThroughJSONTree`         |
| `valueRenderer*`    | **function** (<br />`valueAsString`\*: `any`<br />`value`\*: `any`<br />`keyPath`\*: (`string`, `number`)<br />\[]<br />) => `ReactChild` \| `ReactFragment` \| `ReactPortal` \| `boolean` \| `null` \| `undefined`                                                                                                                                      | `JSONValueNodeCircularPropsPassedThroughJSONTree`  |
| `shouldExpandNode*` | **function** (<br />`keyPath`\*: (`string`, `number`)<br />\[]<br />`data`\*: `any`<br />`level`\*: `number`<br />) => `boolean`                                                                                                                                                                                                                         | `JSONNestedNodeCircularPropsPassedThroughJSONTree` |
| `hideRoot*`         | `boolean`                                                                                                                                                                                                                                                                                                                                                | `JSONNestedNodeCircularPropsPassedThroughJSONTree` |
| `getItemString*`    | **function** (<br />`nodeType`\*: `string`<br />`data`\*: `any`<br />`itemType`\*: `ReactChild` \| `ReactFragment` \| `ReactPortal` \| `boolean` \| `null` \| `undefined`<br />`itemString`\*: `string`<br />`keyPath`\*: (`string`, `number`)<br />\[]<br />) => `ReactChild` \| `ReactFragment` \| `ReactPortal` \| `boolean` \| `null` \| `undefined` | `JSONNestedNodeCircularPropsPassedThroughJSONTree` |
...
| Name        | Type                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Parent            |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `jsonTree*` | <details><summary>`Partial`</summary><blockquote>`data`\*: `any`<br />`theme`: `string` \| `Base16Theme` \| `StylingConfig`<br />`invertTheme`\*: `boolean`<br />`keyPath`\*: (`string`, `number`)<br />\[]<br />`labelRenderer`\*: **function** (<br />`keyPath`\*: (`string`, `number`)<br />\[]<br />`nodeType`\*: `string`<br />`expanded`\*: `boolean`<br />`expandable`\*: `boolean`<br />) => `ReactChild` \| `ReactFragment` \| `ReactPortal` \| `boolean` \| `null` \| `undefined`<br />`valueRenderer`\*: **function** (<br />`valueAsString`\*: `any`<br />`value`\*: `any`<br />`keyPath`\*: (`string`, `number`)<br />\[]<br />) => `ReactChild` \| `ReactFragment` \| `ReactPortal` \| `boolean` \| `null` \| `undefined`<br />`shouldExpandNode`\*: **function** (<br />`keyPath`\*: (`string`, `number`)<br />\[]<br />`data`\*: `any`<br />`level`\*: `number`<br />) => `boolean`<br />`hideRoot`\*: `boolean`<br />`getItemString`\*: **function** (<br />`nodeType`\*: `string`<br />`data`\*: `any`<br />`itemType`\*: `ReactChild` \| `ReactFragment` \| `ReactPortal` \| `boolean` \| `null` \| `undefined`<br />`itemString`\*: `string`<br />`keyPath`\*: (`string`, `number`)<br />\[]<br />) => `ReactChild` \| `ReactFragment` \| `ReactPortal` \| `boolean` \| `null` \| `undefined`<br />`postprocessValue`\*: **function** (<br />`value`\*: `any`<br />) => `any`<br />`isCustomNode`\*: **function** (<br />`value`\*: `any`<br />) => `boolean`<br />`collectionLimit`\*: `number`<br />`sortObjectKeys`: `function` \| `boolean`<br />`children`: `ReactNode` \| `undefined`</blockquote></details> | `DataViewerProps` |
