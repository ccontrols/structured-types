...
| `labelRenderer*`    | (`keyPath`\*: (`string` \| `number`)\[], `nodeType`\*: `string`, `expanded`\*: `boolean`, `expandable`\*: `boolean`) => { `type`: `T`, `props`: `P`, `key`: `union` } \| `string` \| `number` \| undefined \| ReactNodeArray \| { `key`: `union`, `children`: `ReactNode`, `type`: `T`, `props`: `P` } \| `boolean` \| `null` \| `undefined`                                                                                                                                                                                                                            | `SharedCircularPropsPassedThroughJSONTree`         |
| `valueRenderer*`    | (`valueAsString`\*: `any`, `value`\*: `any`, `keyPath`\*: (`string` \| `number`)\[]) => { `type`: `T`, `props`: `P`, `key`: `union` } \| `string` \| `number` \| undefined \| ReactNodeArray \| { `key`: `union`, `children`: `ReactNode`, `type`: `T`, `props`: `P` } \| `boolean` \| `null` \| `undefined`                                                                                                                                                                                                                                                            | `JSONValueNodeCircularPropsPassedThroughJSONTree`  |
...
| `getItemString*`    | (`nodeType`\*: `string`, `data`\*: `any`, `itemType`\*: { `type`: `T`, `props`: `P`, `key`: `union` } \| `string` \| `number` \| undefined \| ReactNodeArray \| { `key`: `union`, `children`: `ReactNode`, `type`: `T`, `props`: `P` } \| `boolean` \| `null` \| `undefined`, `itemString`\*: `string`, `keyPath`\*: (`string` \| `number`)\[]) => { `type`: `T`, `props`: `P`, `key`: `union` } \| `string` \| `number` \| undefined \| ReactNodeArray \| { `key`: `union`, `children`: `ReactNode`, `type`: `T`, `props`: `P` } \| `boolean` \| `null` \| `undefined` | `JSONNestedNodeCircularPropsPassedThroughJSONTree` |
